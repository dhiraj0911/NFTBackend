                ...
                <div className="relative w-full max-w-lg px-4 md:px-0">
                  <div className="relative bg-white rounded-lg shadow dark:bg-gray-700 mx-auto">
                    ...
                    <div className="flex justify-center">
                      <form className="w-full px-6 py-4 lg:px-8 sm:pb-6 xl:pb-8 space-y-6" action="#">
                        <div>
                          <label htmlFor="assetName" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Asset Name</label>
                        ...
                        <div>
                          <label htmlFor="assetId" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Asset ID</label>
                        ...
                        <div>
                            <label htmlFor="rentPrice" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Rent Price per day</label>
